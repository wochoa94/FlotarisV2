...
export function Dashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="w-[1260px] h-[656px] flex flex-col items-start gap-[20px] self-stretch border border-gray-200 rounded-lg p-5 mx-auto">
        ...
        <Card size="large">
          ...
          <h3 className="text-lg font-medium text-gray-900">Total Maintenance Cost</h3>
          <div className="text-3xl font-bold text-yellow-600">
            ${totalMaintenanceCost.toLocaleString()}
          </div>
          <div className="text-sm text-gray-500">Fleet-wide expenses</div>
        </Card>
        ...
        {summary?.highestMaintenanceCostVehicle && (
          <Card size="large">
            ...
            <h3 className="text-lg font-medium text-gray-900">Highest Cost Vehicle</h3>
        ...
        {summary?.lowestMaintenanceCostVehicle && (
          <Card size="large">
            ...
            <h3 className="text-lg font-medium text-gray-900">Lowest Cost Vehicle</h3>
